...
void show_linenum()
{
    ...
    int cnt_line = 0, cur_line = top_line;
    while (cnt_line < EDT_LINES)
    {
        ...
        if (ENABLED_LINENUM == 1)
        {
            ...
            wmove(numwin, cnt_line, NUM_COLS - line_output.size());
        ...
        int addition_line = get_linenum((int)editor[cur_line++].size());
